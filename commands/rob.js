...
module.exports = {
    name: 'rob',
    cooldown: 10,
    description: 'Kradnie pieniadze z portfela!',
...
if (author !== null && timeout - (Date.now() - author) > 0) {
    ...
    .setColor("#FFFFFF")
    .setDescription(`Już kogoś okradłeś\n\nSpróbuj ponownie za ${time.minutes}m i ${time.seconds}s `);
...
let moneyEmbed2 = new Discord.MessageEmbed()
  .setColor("#FFFFFF")
  .setDescription(`${user.user.username} nie posiada niczego co mógłyś ukraść`);
if (targetuser < 0) {
...
.setDescription(`Okradłeś ${user} i zyskałeś ${random}FC`)
.setColor("#FFFFFF")
